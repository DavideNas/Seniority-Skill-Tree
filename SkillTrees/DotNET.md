...
- **YouTube Videos**:
  ...
  1. [What is .NET? [Pt 1] | .NET for Beginners – Scott Hanselman](https://www.youtube.com/watch?v=6BcPIvVfVAw) ▶️  
     Introduzione al mondo .NET, ideale per principianti.

  2. [ASP.NET Core Full Course For Beginners](https://www.youtube.com/watch?v=AhAxLiGC7Pc) ▶️  
     Corso completo su ASP.NET Core, utile per sviluppare applicazioni web.

- **YouTube Channels**:

  1. [Fireship](https://www.youtube.com/@Fireship) 📺  
     Tutorial rapidi e informativi su tecnologie moderne, inclusi video su .NET.

  2. [The Net Ninja](https://www.youtube.com/@NetNinja) 📺  
     Offre una varietà di corsi su sviluppo web, con contenuti anche su .NET.

- **Articoli**:

  1. [Introduction to .NET Framework – GeeksforGeeks](https://www.geeksforgeeks.org/introduction-to-net-framework/) ✍️  
     Panoramica sul .NET Framework, utile per comprendere le basi.

  2. [C#.NET Tutorials For Beginners and Professionals](https://dotnettutorials.net/course/csharp-dot-net-tutorials/) ✍️  
     Serie di tutorial per imparare C# e .NET passo dopo passo.

- **Documentazione ufficiale / Guide utili**:

  - [Documentazione .NET – Microsoft Learn](https://learn.microsoft.com/en-us/dotnet/) 📘  
    Guida ufficiale con tutorial, esempi di codice e documentazione API.

  - [Learning center | .NET](https://dotnet.microsoft.com/en-us/learn) 📘  
    Centro di apprendimento con tutorial, video e corsi gratuiti.

- **Best Course**:  
  [Becoming a .NET Developer – Pluralsight](https://www.pluralsight.com/courses/becoming-dotnet-developer) �  
  Corso completo per iniziare il percorso da sviluppatore .NET, con esercizi pratici e esempireali.
...
- **Libri**:
  ...
  - 📕 _Pro ASP.NET Core 6_ – Adam Freeman  
    Guida approfondita su ASP.NET Core 6, ideale per sviluppatori web.

  - 📘 _C# 10 and .NET 6 – Modern Cross-Platform Development_ – Mark J. Price  
    Copre lo sviluppo multipiattaforma con C# 10 e .NET 6.

  - 📙 _CLR via C#_ – Jeffrey Richter  
    Approfondimento sul Common Language Runtime e C#.

- **Corsi Consigliati dalla Community**:

  1. **[.NET FullStack Developer – Coursera](https://www.coursera.org/courses?query=net)**  
     Percorso completo per diventare sviluppatore Full Stack con .NET. 🌐

  2. **[Top .NET Courses Online – Udemy](https://www.udemy.com/topic/net/)**  
     Ampia selezione di corsi su .NET, ASP.NET, C# e altro. 🌐

  3. **[.NET Online Training Courses – LinkedIn Learning](https://www.linkedin.com/learning/topics/dot-net)**  
     Corsi online su .NET, dalla programmazione di base a tecniche avanzate. 🌐
